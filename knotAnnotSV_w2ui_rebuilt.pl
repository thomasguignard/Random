...
\n</head>
\n<body>
\n<div style=\"width: 98%; margin: 10px 10px 10px 10px; text-align:right;display: inline-block\"> <h3 style=\"margin: 0px 0px 0px 0px;\">".$outPrefix.$outBasename." in ".$genomeBuild."<a href=\"https://github.com/mobidic/knotAnno    tSV\"  target=\"_blank\" rel=\"noopener noreferrer\" ><img src=\"https://github.com/mobidic/knotAnnotSV/raw/master/images/logoKNOT.png\" style=\"display:inline; width:12em;height:3em;\" align=\"left\" alt=\"Logo is Knot here.\"></a></h3></div>
			...
			if (defined  $dataCommentHash{$OutColHash{$col}{'field'}} ){
				$htmlStart .= "\t\t\t{field: \"".$OutColHash{$col}{'field'}."\", caption: \"".$OutColHash{$col}{'RENAME'}."\", size: '30%',\n
					render: function(record) {\n
						var html = '<div style=\"padding: 10px; maw-width: 600px\">'+
...
foreach my $col (sort {$a <=> $b} keys %OutColHash){
	...
	if (defined $OutColHash{$col}{'field'} && $col != 0){
		if (defined  $dataCommentHash{$OutColHash{$col}{'field'}} ){
			$htmlStart .= "\t\t\t{field: \"".$OutColHash{$col}{'field'}."_comment\", caption: \"".$OutColHash{$col}{'field'}."_comment\", size: '30%', hidden: true},\n";
		}
	}
}
