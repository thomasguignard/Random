...
my $htmlALL= "<div id=\"ALL\" class=\"tabcontent\">\n\t<table id='tabALL' class='display' >\n\t\t<thead><tr>".$htmlStartTable;
my $htmlACMG="<div id=\"ACMG\" class=\"tabcontent\">\n\t<table id='tabACMG' class='display' >\n\t\t<thead><tr>".$htmlStartTable;
 
my $htmlMETA="<div id=\"METADATA\" class=\"tabcontent\">\n\t<table id='tabMETADATA' class='display' >\n\t\t<thead><tr>".$htmlStartTable;

my $htmlOMIMDOM=$htmlStartTable;
my $htmlOMIMREC=$htmlStartTable;
my $htmlCANDIDATE=$htmlStartTable;


my $htmlDENOVO=$htmlStartTable;
...
my $htmlEnd = "<div class=\"tab\">\n
					...
					<button class=\"tablinks\" onclick=\"openCity(event, 'ACMG')\">ACMG</button>\n
			</div>";
...
foreach my $field ( @{$hashFinalSortData{$rank}{$variant}{'finalArray'}} ){
	...
	if (defined $field){
		#print HTML $field;
		$htmlALL .= "<div class=\"tooltip\">".$field."<span class=\"tooltiptext tooltip-bottom\">".$field."</span></div>";
	}else {
		#print HTML "."
		$htmlALL .= "."
	}
